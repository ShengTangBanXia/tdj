package com.tdj.logistics_system.config.shiro;
...
//安全管理器組件
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean() {
		...
		FilterFactoryBean.setSecurityManager(securityManager());
	  	FilterFactoryBean.setLoginUrl("/account/login");//这是login   form上的
		//FilterFactoryBean.setLoginUrl("/api/login");//这是login   form上的
		FilterFactoryBean.setSuccessUrl("/common/dashboard");//  这是登录成功的    这个是用于thymeleaf  jsp  只能用form表单登录
		...
		//map.put("/account/dashboard", "anon");
